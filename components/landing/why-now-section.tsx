    ...
    >
      ...
      <div className="relative mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-12">
        ...
        <figure className="mx-auto max-w-4xl rounded-2xl border border-border/40 bg-card/25 p-6 sm:p-8 backdrop-blur-md transition-all duration-300">
          <Sparkles
            aria-hidden="true"
            className="size-5 text-[var(--landing-accent)] mb-3"
          />
              ...
              >
                <div>
                  <div className="flex items-center justify-between gap-3">
                    <span className="flex size-8 items-center justify-center rounded-lg border border-border/40 bg-background/50 text-[var(--landing-accent)] group-hover:scale-[1.02] transition-transform duration-300">
