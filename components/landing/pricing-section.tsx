          ...
          {PLAN_COPY.map((plan, index) => (
            <div
              className={cn(
                ...
                plan.highlight
                  ? "landing-glass border-[var(--landing-accent)]/45 shadow-[0_0_32px_var(--landing-accent-glow)]"
                  : "landing-glass border-[var(--landing-border)] hover:border-[var(--landing-border-hover)]",
                isVisible
                  ? "translate-y-0 opacity-100"
                  : "translate-y-6 opacity-0"
              )}
            ...
            >
              {plan.badge ? (
                <span className="absolute -top-3 left-6 inline-flex items-center gap-1 rounded-full bg-[var(--landing-accent)] px-3 py-1 font-semibold text-[9px] text-white uppercase tracking-wider shadow-[0_0_20px_var(--landing-accent-glow)]">
                  {plan.badge}
                </span>
              ) : null}
        ...
        <table className="w-full min-w-[640px] border-collapse text-left text-sm">
          <thead>
            <tr className="border-border/50 border-b">
              ...
              <th className="px-5 py-4 font-medium text-[var(--landing-accent)]">
                Hosted
                <span className="ml-1.5 font-mono text-[10px] text-muted-foreground/60">
                  Pro
                </span>
